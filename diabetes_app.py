...
st.write("""
# Gestational Diabetes Risk Detection
 Detect if someone has diabetes using machine learning and Streamlit!
""")
image = Image.open('diabetes_app_image.jpg')
...
st.subheader('Outcome (0-Low Risk, 1-High Risk): ')
st.write(prediction)
